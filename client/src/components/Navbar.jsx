      ...
      <div>
        <div class='navPc'>
            <div class="d-flex gap-5 mx-5">
                <p class='fw-bold' style={{cursor:'pointer'}} onClick={()=>navigate('/createbook')}>AddBook</p>
                 <p class='fw-bold' style={{cursor:'pointer'}}  onClick={()=>navigate('/book_store')}>Book</p>
